...
class KlbrkSocket {
    ...
    private static final int g_xor_key = -709282654;
    ...
    public int send(int var1, int var2, int var3, byte[] var4) throws SocketException {
        ...
        boolean var8 = false;
        int var6 = 16 + var3;
        int var7 = var6 ^ -709282654;
        this.m_send = new byte[var6];
        KlbrkUtil.int2bytes(var6, this.m_send, 0);
        KlbrkUtil.int2bytes(var7, this.m_send, 4);
        KlbrkUtil.int2bytes(var2, this.m_send, 8);
        KlbrkUtil.int2bytes(var1, this.m_send, 12);
    ...
    public int recv() throws IOException {
        ...
        if (var4 == null) {
            ...
            this.m_svr_rc = KlbrkUtil.bytes2int(var4, 8);
    ...
    private byte[] receive() throws IOException {
        ...
        if (var7 < 0) {
            ...
            int var2 = KlbrkUtil.bytes2int(var5, 0);
            int var4 = KlbrkUtil.bytes2int(var5, 4);
            var4 ^= -709282654;
            if (var2 != var4) {
                this.m_msg = "incompatible client version (" + var2 + ", " + var4 + ", " + -709282654 + ")";
                return null;
            } else {
                int var3 = var2 - 8;
