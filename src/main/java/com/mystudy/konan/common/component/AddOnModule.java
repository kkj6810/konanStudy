...
public class AddOnModule {
    ...
    // 공통
    @Value("#{commonConfig['addon.addr']}") private String addr;
    @Value("#{commonConfig['addon.etc']}") private String etc;
    @Value("#{commonConfig['addon.language']}") private int language;
    @Value("#{commonConfig['addon.charset']}") private int charset;
