...
public class DCUtil {
    ...
    public String getRestURL(ParameterVO paramVO, SearchVO searchVO) throws UnsupportedEncodingException {
        ...
        url.append("&hilite-fields=" +searchVO.getHiliteFileds());
        url.append("&hilite-keywords=" +searchVO.getHiliteTxt());
        ...
        if(searchVO.getDefaultHilite() != null && !"".equals(searchVO.getDefaultHilite())) url.append("&default-hilite=" +searchVO.getDefaultHilite());
        return url.toString();
    }
}