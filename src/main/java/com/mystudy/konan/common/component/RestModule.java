...
public class RestModule {
	...
	@Value("#{commonConfig['engine.url']}") protected String engineUrl;
	
	@Value("#{commonConfig['engine.charsetType']}") protected String charsetType;
	
	@Value("#{commonConfig['ksf.charsetType']}") protected String ksfCharsetType;
	
	@Value("#{commonConfig['useWarning']}") protected boolean useWarning;
	
	@Value("#{commonConfig['ksf.url']}") protected String ksfUrl;
	
	@Value("#{commonConfig['HTTP_TIMEOUT']}") protected int timeout;
